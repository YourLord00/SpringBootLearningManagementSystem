...
public class UniversityClassController {
    ...
    public ResponseEntity<String> addClass(@RequestBody UniversityClass universityClass) {
        try {
            UniversityClass addUniversityClass = universityClassService.addClass(universityClass);
            return ResponseEntity.ok("add university class. " + addUniversityClass.toString());
